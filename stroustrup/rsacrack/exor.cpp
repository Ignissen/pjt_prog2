...
void print_help()
{
    std::cout << "Use: ./ceasar [encrypt/decrypt] [character to exor with]\tThis way it will read the standard input." << '\n';
    std::cout << "If you use it manually (not attaching a file to the satndard input), you have to exit the program via CTRL+D" << '\n';
    std::cout << "Use: ./ceasar [encrypt/decrypt] [string to encrypt] [character to exor with]\tThis way it will read the second argument as input." << '\n';
